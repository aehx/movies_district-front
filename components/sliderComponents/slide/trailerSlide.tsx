...
export default function TrailerSlide(props: TMDBMovieData) {
  ...
  return (
    <div className="h-[200px] flex justify-center">
      ...
      >
        <Image src={`${img_base_url}${props.backdrop_path}`} alt={props.title} priority={true} fill sizes="(max-width: 768px) 100vw,
              (max-width: 1200px) 50vw,
              33vw" className="absolute top-0 h-full w-full object-cover hover:scale-110 hover:opacity-30 transition-all duration-1000"/>
