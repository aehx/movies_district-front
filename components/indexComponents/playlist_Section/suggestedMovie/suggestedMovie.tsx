...
export default function SuggestedMovie(props: PropsSuggested) {
  ...
  return (
    <div className="w-11/12 xl:w-9/12 lg:max-h-[50vh] bg-zinc-900 bg-[rgba(24,24,27,0.7)] flex flex-col lg:flex-row ">
      ...
      <Image src={`${img_base_url}${suggested?.backdrop_path}`} alt={suggestedTitle} loading="lazy" fill className="object-cover md:object-cover lg:h-full xl:object-center" sizes="(max-width: 768px) 100vw,
