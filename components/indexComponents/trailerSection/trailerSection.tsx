...
export default function TrailerSection(props: PropsArrayOfMovieData) {
  return (
    <div className="w-full  bg-black pb-20 pt-14">
      ...
      <div className="w-screen h-[40px] z-50 bg-[url('/images/cinema.png')] bg-repeat-x bg-cover invert opacity-70 mb-3" style={{backgroundSize:"40px"}}>
      </div>
      <RowSlider
        nbrOfSlides={5}
      ...
      />
      <div className="w-screen h-[40px] z-50 bg-[url('/images/cinema.png')] bg-repeat-x bg-cover rotate-180 invert opacity-70 mt-3" style={{backgroundSize:"40px"}}>
      </div>
    </div>
  );
}
